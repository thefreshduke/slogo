...
public class VariableTable extends Pane {
	...
	public VariableTable(){
		...
		myVariableColumn.getColumns().addAll(makeVariableNameColumn(), makeVariableValueColumn());
		createTimeLine();


		variables.getColumns().addAll(myVariableColumn);
		functions.getColumns().addAll(makeFunctionsVariableColumn());
	...
	private void makeTableView(TableView myTable){
	...
	private TableColumn makeFunctionsVariableColumn(){
