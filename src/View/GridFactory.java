...
public class GridFactory {
    ...
    public GridFactory (int width, int height, KeyFrame frame,
            HashMap<String, GUIFunction> myHashMap) throws ClassNotFoundException {
        myWidth = width;
        myHeight = height;
        myFrame = frame;
        myMap = myHashMap;
    ...
    public Grid makeGrid (String s) throws InstantiationException, IllegalAccessException,
            IllegalArgumentException, InvocationTargetException, NoSuchMethodException,
            SecurityException {
        Grid myGrid = null;
        myGrid = (Grid) myGrids.get(s)
                .getConstructor(int.class, int.class, KeyFrame.class, HashMap.class, int.class)
                .newInstance(myWidth, myHeight, myFrame, myMap, my_ID++);
        allGrids.add(myGrid);
        return myGrid;
