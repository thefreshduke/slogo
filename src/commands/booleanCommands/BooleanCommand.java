...
public abstract class BooleanCommand extends LogicCommand {

    private BaseCommand[] myArgumentList;

    public BooleanCommand(String userInput, boolean isExpression) throws BackendException {
        super(userInput, isExpression);
    }

    @Override
    public final double execute() throws BackendException{
        double result = booleanExecute();
        BaseCommand nextCommand = getNextCommand();
        return nextCommand == null ? result : executeCommand(nextCommand);
    }
    
    public abstract double booleanExecute() throws BackendException;
