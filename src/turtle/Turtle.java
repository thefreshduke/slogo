...
public class Turtle extends ImageView implements ITurtleBehavior {
    ...
    public void move (double xPos, double yPos) {
        moveHorizontal(xPos);
        moveVertical(yPos);
        myPastPositions.push(new Position(myPosition.getXPos(), myPosition.getYPos(), myPosition
                .getRotate()));
    }
    ...
    public void move (KeyCode e) {
        ...
        if (myTempPosition != null) {
            ...
            myPastPositions.add(new Position(myTempPosition.getXPos(), myTempPosition.getYPos(),
                    myTempPosition.getRotate()));
        }
    ...
    public double setPosition (double newXPos, double newYPos) {
        double distance = Math.sqrt(Math.pow(getXYCoordinates()[0] - newXPos, 2)
