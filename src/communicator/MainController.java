...
public class MainController extends BaseController {
	...
	@Override
	public IInformationContainer loadPreferences(IInformationContainer container, File file) throws BackendException {
		FileInputStream fis = null;
		ObjectInputStream in = null;
		IVariableContainer returnContainer = null;
		try {
			fis = new FileInputStream(file);
			in = new ObjectInputStream(fis);
			returnContainer = (IVariableContainer) in.readObject();
			in.close();
		} catch (Exception ex) {
	...
	@Override
	public void savePreferences(IInformationContainer container, String filename) throws BackendException {
		FileOutputStream fos = null;
		ObjectOutputStream out = null;
		try {
			fos = new FileOutputStream(filename);
			out = new ObjectOutputStream(fos);
			out.writeObject((IVariableContainer) container);
			out.close();
		} catch (Exception ex) {
